...
def create(request):
	if request.method == "POST":
		...
		return render(request, "pastebin/create.html")
...
def show(request, code):
	...
	return render(request, "pastebin/show.html", {"code":bin_.code, "content":bin_.content.splitlines()})
...
def list_(request):
	return render(request, "pastebin/list.html")