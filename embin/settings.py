"""
Django settings for embin project.
...
SECRET_KEY = 'rt$$q7m*v7+t%cqvfbsj+9%ek^xe^f$o96b4o4z7cd1@jv9s0@'
...
INSTALLED_APPS = [
    ...
    "corsheaders", # django-cors-headers module
...
ROOT_URLCONF = 'embin.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': ["templates"],
        'APP_DIRS': True, # permet de détecter les dossier templates dans les applications
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'embin.wsgi.application'
